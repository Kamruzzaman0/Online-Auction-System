...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('admin_product_add')}}" method="post" enctype="multipart/form-data">
...
<table class="table" style="border: 1px solid black;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn" href="{{route('admin_product_edit', $product->id)}}" role="button"><i class="fa-solid fa-pen-to-square"></i></a>
                ...
                <div class="modal fade" id="delcatModal{{$product->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <a type="button" class="btn btn-danger" href="{{route('admin_product_delete', $product->id)}}">Confirm</a>
