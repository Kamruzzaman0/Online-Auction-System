...
<table class="table">
    <thead>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn" href="{{route('admin_category_edit', $category->id)}}" role="button"><i class="fa-solid fa-pen-to-square"></i></a>
                ...
                <div class="modal fade" id="delcatModal{{$category->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <a type="button"  class="btn btn-danger" href="{{route('admin_category_delete', $category->id)}}">Confirm</a>
